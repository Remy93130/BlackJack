...
public class MainActivity extends AppCompatActivity {
    ...
    // Attributes from SharedPreferences
    ...
    private void displayLayoutProperly() {
        addToPanel(layoutCardBank, "invisible");
        addToPanel(layoutCardPlayer, "invisible");
        addToPanel(layoutResultBank, "invisible");
        addToPanel(layoutResultPlayer, "invisible");
    }
